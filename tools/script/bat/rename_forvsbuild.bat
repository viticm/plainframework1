...
echo (1)all (2)billing (3)pf_simple (4)pf_core (5)sharememory (6)login (7)center (8) plugin_pak
set /p select=your select?
echo revert to standard?
set revert=-1
set /p revert=(yes/no)?
set all="pf_core|pf_simple|billing|sharememory|login|center|plugin_pak"
